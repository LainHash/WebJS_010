...
export default function Edit() {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      name: laptop.Name ?? "",
      type: laptop.Type ?? "",
      inches: laptop.Inches != null ? String(laptop.Inches) : "",
      screen: laptop.ScreenResolution ?? "",
      memory: laptop.Memory != null ? String(laptop.Memory) : "",
      os: laptop.OpSys ?? "",
      weight: laptop.Weight != null ? String(laptop.Weight) : "",
      unitPrice: laptop.UnitPrice != null ? String(laptop.UnitPrice) : "",
      unitsInStock:
        laptop.UnitsInStock != null ? String(laptop.UnitsInStock) : "",
    });
  }, [laptop]);
  ...
  if (loadingLaptop) return <div className="p-8">Loading...</div>;
  if (loadError)
    return (
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link to={`/LaptopList/${id}`} className="text-sm text-gray-600">
          Detail
        </Link>
      </div>
